...
class DetailCpLele extends StatefulWidget {
  final String? idKolam;

  const DetailCpLele({super.key, this.idKolam});

  @override
  State<DetailCpLele> createState() => _DetailCpLeleState();
}

class _DetailCpLeleState extends State<DetailCpLele> {
