...
class DetailCpAyam extends StatefulWidget {
  final String? idKandang;

  const DetailCpAyam({super.key, this.idKandang});

  @override
  State<DetailCpAyam> createState() => _DetailCpAyamState();
}

class _DetailCpAyamState extends State<DetailCpAyam> {
