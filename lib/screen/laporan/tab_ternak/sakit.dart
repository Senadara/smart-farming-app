...
class SakitTab extends StatelessWidget {
  ...
  String _generateRangkumanSakit() {
    ...
    // Handle empty state when no sick animals occurred
    if (totalSakit == 0) {
      return "Berdasarkan statistik $periodeText, tidak ditemukan kasus ternak sakit. Kondisi ini menunjukkan bahwa ternak dalam keadaan sehat dan terawat dengan baik.";
    }
              ...
              reports: riwayatSakitState.items.map((item) {
                ...
                return {
                  'id': item['id'] as String? ??
                      ...
                      '',
                  'text':
                      (item['Sakit']['diagnosisPenyakit'] as String).isEmpty || (item['Sakit']['diagnosisPenyakit'] as String).toLowerCase() == 'unknown'
                          ? item['judul']
                          : item['Sakit']['diagnosisPenyakit'],
